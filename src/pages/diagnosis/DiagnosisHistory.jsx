...
function DiagnosisCard({ record }) {
  return (
    <Link to={`/diagnosis/${record.id}`}>
      <Card
        className="p-6 hover:shadow-lg transition-all duration-300 hover:scale-[1.02] cursor-pointer border-l-4 border-l-blue-500 mb-4"
      >
        <div className="flex flex-col gap-4">
          <div className="flex justify-between lg:items-center items-start flex-col lg:flex-row">
            <h2 className="lg:text-2xl font-semibold text-blue-500">{record.title}</h2>
    ...
    <div className="min-h-screen p-6 lg:px-[10%] bg-gray-50">
      <div className="space-y-8">
        <div className="flex justify-between items-center mb-12">
          <h1 className="text-2xl lg:text-3xl font-bold text-blue-500">Diagnosis History</h1>
